...
export function Header({handleClick}:{handleClick:()=> void}) {
  return  <header className="flex h-24 items-center px-8 bg-white shadow-lg">
    <Image src={logoSrc} alt="logo" width={53}></Image>
  <div className="w-px h-8 bg-slate-200 mx-6"/>
  <Button className="w-44 bg-teal-600 hover:bg-teal-500 transition-colors text-white rounded-lg py-2 px-5 text-2xl leading-tight"
